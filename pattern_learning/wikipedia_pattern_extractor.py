...
class WikipediaPatternExtractor(PatternTool):
    def __init__(self, relation_types_limit, facts_limit, resources_path='../data/mappingbased_objects_en.ttl',
                 ...
                 replace_redirects=False, patterns_output_path='../data/patterns_raw.pkl'):
    ...
    def discover_patterns(self):
        ...
        1. Filter relevant DBpedia facts by relation types -> still TODO
        ...
        for entity, values in tqdm(self.dbpedia.iteritems(), total=len(self.dbpedia)):
            # for each relation type filter sentences that contain
            # target resources of entity's relation type
