...
class FactExtractor(object):
    def __init__(self, limit, use_dump=False, randomize=False, match_threshold=0.01, load_path='../data/patterns.pkl',
...
def parse_input_parameters():
    ...
    for arg in sys.argv[1:]:
        if arg == '--dump':
            ...
            print 'Usage: python fact_extractor.py [--dump] [--rand] [--test]'
            helped = True
...
if __name__ == '__main__':
    ...
    fact_extractor = FactExtractor(20, use_dump=use_dump, randomize=randomize)
    fact_extractor.discover_new_facts()
